...
Value = Struct.new(:oid, :mod, :sql_type, :mpg_class, :literal, :expected)
...
module MosesPG
  ...
  module Datatype
    ...
    Types = [
      # OID      Mod  SQL type            MPG class        text literal              expected native value
      # numeric
      [  21,      -1, 'smallint',         Smallint,                  '12',                      12           ],
      [  23,      -1, 'integer',          Integer,                  '123',                     123           ],
      [  20,      -1, 'bigint',           Bigint,          '123456789012',            123456789012           ],
      [1700, 1310734, 'numeric(20,10)',   Numeric,           '1234567890.1234567890',   1234567890.1234567890],
      ...
      # character
      [1043,      34, 'varchar(30)',      Varchar,         'Hello world',             'Hello world'          ],
      [1042,      14, 'char(10)',         BPChar,          'Hello     ',              'Hello     '           ],
    ...
    describe Base do
      before(:each) do
        @types = Array.new(Values.size) { |i| Datatype::Base.create(Values[i].oid, Values[i].mod) }
      end
      ...
      describe '::create' do
        it 'instantiates the proper subclass for the OID' do
          @types.each_with_index do |type, i|
            ...
            type.should be_instance_of(Values[i].mpg_class)
          end
        end
      end
